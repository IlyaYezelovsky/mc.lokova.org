...
# LokovaMC Server Rules

***This is a translated text and should not be considered a replacement for the [original text](https://mc.lokova.org/rules/ "original text").***

## Introduction

*LokovaMC is a survival server centered on **high freedom** and **surpassing the vanilla**. We respect players' creativity, playstyles, and normal communication. Except in cases of clear rule violations, the server maintenance team will not intervene. These rules aim to ensure normal gameplay for all players and stable server operation, **and do not include fairness or emotional considerations**. The maintenance team will only address behaviors that clearly violate the rules and negatively impact others or the server.*
...
**Promoting fascism, extremism, or terrorism is strictly prohibited. Content related to real-world politics, religion, racial conflict, insults against any country/region, or drugs is strictly prohibited.**

**Personal attacks and vulgar behavior are strictly prohibited.**

**Any player account found engaging in such illegal or rule-breaking behavior will be permanently banned immediately.**

## Rule Enforcement Instructions

Server rules are primarily enforced based on player reports. When reporting, please provide clear, complete, and verifiable evidence (such as screenshots or videos). The maintenance team will process reports based on the evidence and the actual circumstances.
